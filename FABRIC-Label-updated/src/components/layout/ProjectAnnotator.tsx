      ...
      <div className="flex items-center justify-between px-5 py-3 border-b border-[var(--border)] bg-[var(--bg-secondary)]">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="text-xs bg-[var(--bg-surface)] border border-[var(--border)] hover:border-emerald-500/50 text-gray-300 hover:text-white px-4 py-2 rounded-lg"
          >
            Label
          </button>
                        ...
                        <button
                          ...
                          className={`text-xs px-3 py-1.5 rounded-lg border transition-all ${
                            active
                              ...
                              : "bg-[var(--bg-surface)] border-[var(--border)] text-gray-400 hover:text-white hover:border-emerald-500/50"
                          }`}
                        >
                          {name}
